...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  void sendMessage(TSendMessageCondition sendMessageCondition)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := service.NewTMessageThriftServiceClientFactory(trans, protocolFactory)
	...
	case "sendMessage":
		...
		argvalue0 := service.NewTSendMessageCondition()
